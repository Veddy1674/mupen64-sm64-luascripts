...
-- 2. lua pauses the game, writes the action and reward to a file, creates a screenshot of the game
...
local screenshotPath = "lua/tasbots/pyDQN/filemethod/temp/"

local pauseWhenEnd = true -- pause the game when the episode ends (both success and failure)
...
local function makeScreenshot()
    emu.screenshotRaw(screenshotPath)
end

if true then return end -- unfinished
